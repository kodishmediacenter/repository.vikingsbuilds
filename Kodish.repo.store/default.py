...
def CATEGORIES():
    link = OPEN_URL('https://raw.githubusercontent.com/kodishmediacenter/store/master/kstorenepoceno').replace('\n','').replace('\r','')
...
def menukodish():
       dialog = xbmcgui.Dialog()
       ret = dialog.select('[COLOR yellow]Bem Vindo a Kodish Store[/COLOR]', ['Addons Gerais', 'Kodi Repositorios','Lojink', 'Ativar Addon (kodi17)','Ativar Addon Manualmente (kodi17)','Addons Nao Homologados Homebrew','Salvar o Log do Kodi','Deixar o Kodi em PT-BR'])
